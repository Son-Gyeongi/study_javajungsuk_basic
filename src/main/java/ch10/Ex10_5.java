...
public class Ex10_5 {
    public static void main(String[] args) {
        ...
        int year = Integer.parseInt(args[0]); // 년 / Integer.parseInt 문자열이 숫자로 변한다.
        ...
        // 매 달마다 끝나는 날이 달라서 다음달의 첫날에서 하루를 뺸다.
        ...
        for (int i = 1, n = START_DAY_OF_WEEK; i <= END_DAY; i++, n++) {
            ...
            if (n%7==0) System.out.println(); // 토요일 될 떄마다 줄바꿈
        }
    }
}
